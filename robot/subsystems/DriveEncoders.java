...
public class DriveEncoders extends Subsystem {
	...
	public DriveEncoders(int leftChannelA, int leftChannelB, /*int rightChannelA,int rightChannelB,*/ double maxPeriod,
			int minRate, double distancePerPulse, boolean reverseDirection,int samplesToAverage) {
